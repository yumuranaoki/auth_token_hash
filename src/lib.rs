...
fn generate_sha256_hash(access_token: &[u8]) -> DigestResult {
...
fn generate_sha384_hash(access_token: &[u8]) -> DigestResult {
...
fn generate_sha512_hash(access_token: &[u8]) -> DigestResult {
...
#[cfg(test)]
mod tests {
    use crate::{get_at_hash, Algorithm};

    #[test]
    fn test_rs256() {
        let access_token = String::from("wDUTUjpF9JE6hjAp7qlAZWT7");
        let result = get_at_hash(access_token, Algorithm::RS256);
    ...
    fn test_rs384() {
        ...
        let result = get_at_hash(access_token, Algorithm::RS384);
    ...
    fn test_rs512() {
        ...
        let result = get_at_hash(access_token, Algorithm::RS512);
